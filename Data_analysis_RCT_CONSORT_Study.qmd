...
title_abstract_screening_temp_url <- "" # Note: Use link from page after selecting "raw" button, otherwise it loads all page data 
...
full_text_screening_temp_url <- "" # Note: Use link from page after selecting "raw" button, otherwise it loads all page data 
