...
write.csv(abstract_adherence_data, "Data/abstract_adherence_data.csv")

abstract_adherence_data_url <- "https://github.com/rheirene/behav_addic_consort_adherence_outcome_switch/blob/main/Data/abstract_adherence_data.csv"

abstract_adherence_data <- read.csv(abstract_adherence_data_url) %>%
  as_tibble()
